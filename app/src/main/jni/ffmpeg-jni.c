...
JNIEXPORT jboolean JNICALL Java_com_ifmo_youshare_Ffmpeg_init(JNIEnv *env, jobject thiz, jint width, jint height, jint audio_sample_rate, jstring rtmp_url);
JNIEXPORT void JNICALL Java_com_ifmo_youshare_Ffmpeg_shutdown(JNIEnv *env, jobject thiz);
JNIEXPORT jint JNICALL Java_com_ifmo_youshare_Ffmpeg_encodeVideoFrame(JNIEnv *env, jobject thiz, jbyteArray yuv_image);
JNIEXPORT jint JNICALL Java_com_ifmo_youshare_Ffmpeg_encodeAudioFrame(JNIEnv *env, jobject thiz, jshortArray audio_data, jint length);
...
JNIEXPORT jboolean JNICALL Java_com_ifmo_youshare_Ffmpeg_init(JNIEnv *env, jobject thiz, jint width, jint height, jint audio_sample_rate_param, jstring rtmp_url) {
